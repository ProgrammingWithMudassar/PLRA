...
const Basic__Information = () => {
            ...
            >
              <MenuItem onClick={onView}>
                <ListItemIcon>
                  ...
                  <VisibilityIcon
                    fontSize="small"
                    sx={{ color: "rgba(255, 179, 46, 0.7)", fontSize: "15px" }}
                  />{" "}
                </ListItemIcon>
                <Typography variant="body2" color="initial" ml={-1.5}>
                  View
                </Typography>
              </MenuItem>
              <MenuItem onClick={onEdit}>
                <ListItemIcon>
                  <EditIcon
                    fontSize="small"
                    sx={{ color: "rgba(101, 176, 255, 0.7)", fontSize: "15px" }}
                  />
                </ListItemIcon>
                <Typography variant="body2" color="initial" ml={-1.5}>
                  Edit
              ...
              <MenuItem onClick={onDelete}>
                <ListItemIcon>
                  <DeleteIcon
                    fontSize="small"
                    sx={{ color: "rgba(255, 80, 80, 0.7)", fontSize: "15px" }}
                  />
                </ListItemIcon>
                <Typography variant="body2" color="initial" ml={-1.5}>
                  Delete
  ...
  return (
    <>
      <div style={{paddingTop: '0.7rem', paddingBottom: '0.7rem'}}>
        ...
        {selectedRowData && (
          <Grid container spacing={8} sx={{ p: 2 }}>
            <Grid item xs={12} sx={{ textAlign: "center" }}>
              ...
              >
                {selectedRowData.title.employee_title}{" "}
                {selectedRowData.first_name} {selectedRowData.last_name} :{" "}
                {selectedRowData.employee_no}
              </Typography>
            </Grid>

            <Drawar_Tabbar />
            <Grid item sx={{ width: "100%" }} xs={12} md={3}>
              <Button variant="contained" sx={{ width: "120px", mr: "20px" }}>
                Edit
              </Button>
              <Box
                className="Basic_Profile_Img"
                sx={{ mb: 4, objectFit: "contain", overflow: "hidden" }}
              >
              ...
              <Box sx={{ mb: 1 }}>
                ...
                <Typography variant="body2" color="initial">
                  {selectedRowData.reporting_officer}
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} md={3}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="initial">
                  {selectedRowData.service_duration}
                </Typography>
              </Box>
              <Box sx={{ mb: 1 }}>
                <label name="name">Father Name:</label>
            ...
            <Grid
              item
              xs={12}
              sx={{ textAlign: "right", mt: -6, width: "350px" }}
            >
              <Link
                to={`/employee/basic_information/EditEmployee/${selectedRowData.id}`}
              >
                <Button variant="contained" sx={{ width: "120px", mr: "20px" }}>
                  Edit
                </Button>
